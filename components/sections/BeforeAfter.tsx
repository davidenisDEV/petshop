...
export function BeforeAfter() {
  ...
  return (
    <section className="py-24 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 right-[10%] w-[400px] h-[400px] bg-primary/20 blur-[120px] rounded-full pointer-events-none -translate-y-1/2 z-0"></div>
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-accent font-display text-2xl">Estética Animal</span>
          </div>
          <h2 className="text-4xl md:text-5xl mb-4 text-text-main">
            O verdadeiro <span className="text-primary-dark">Dia de Spa.</span>
          </h2>
        ...
        <div className="relative max-w-4xl mx-auto aspect-square md:aspect-video rounded-[40px] overflow-hidden shadow-2xl border-8 border-white group">
          ...
          />
          <div className="absolute top-6 right-6 bg-white/80 backdrop-blur-md px-4 py-2 rounded-full font-bold text-sm text-text-muted shadow-sm z-0">
            Antes
          </div>
        ...
        <div className="mt-12 text-center">
          <button 
            ...
            className="bg-primary text-accent font-bold px-8 py-4 rounded-full inline-flex items-center gap-3 hover:bg-primary-dark transition-all shadow-lg hover:-translate-y-1"
          >
